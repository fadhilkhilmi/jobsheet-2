...
queue.push("Product A");
queue.push("Product B");
queue.push("Product C");

console.log(queue);

const removedProduct = queue.shift();

console.log("Data yang diambil:", removedProduct);
console.log("Queue setelah shift:", queue);
...
const firstProduct = productQueue.shift();

console.log("Produk yang diambil:", firstProduct);
console.log("Jumlah produk dalam queue:", productQueue.length);
...
stack.push("Product A");
stack.push("Product B");
stack.push("Product C");

console.log(stack);

const removedProduct = stack.pop();

console.log("Data yang diambil:", removedProduct);
console.log("Stack setelah pop:", stack);
...
const lastProduct = productStack.pop();

console.log("Produk yang diambil:", lastProduct);
console.log("Jumlah produk dalam stack:", productStack.length);
